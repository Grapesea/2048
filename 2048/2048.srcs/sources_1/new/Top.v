...
module top_2048 (
    ...
    // 用户输入接口
    input  wire        key_up,        // 上移键
    input  wire        key_down,      // 下移键  
    input  wire        key_left,      // 左移键
    input  wire        key_right,     // 右移键
    input  wire        key_restart,   // 重新开始键
    ...
    input_controller u_input_ctrl (
        ...
        // 原始按键输入
        .key_up_raw(key_up),
        .key_down_raw(key_down),
        .key_left_raw(key_left),
        .key_right_raw(key_right),
        .key_restart_raw(key_restart),
